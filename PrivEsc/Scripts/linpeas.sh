...
user@debian:~/tools/privesc-scripts$ ^C
user@debian:~/tools/privesc-scripts$ clear
user@debian:~/tools/privesc-scripts$ less linpeas.sh
user@debian:~/tools/privesc-scripts$ vim linpeas.sh
user@debian:~/tools/privesc-scripts$ vim linpeas.sh
user@debian:~/tools/privesc-scripts$ clear
user@debian:~/tools/privesc-scripts$ python3 -m http.server 9999
-bash: python3: command not found
user@debian:~/tools/privesc-scripts$ clear
user@debian:~/tools/privesc-scripts$ cat linpeas.sh
#!/bin/sh
